...
import Svg, { Path, G, Rect, Circle, SvgProps } from 'react-native-svg';
/* SVGR has dropped some elements not supported by react-native-svg: title */
const Android = (props: SvgProps) => (
  <Svg data-name="Layer 1" width={1097.1} height={807.9} viewBox="0 0 1097.1 807.9" {...props}>
    <Path
    ...
    <Rect x={370.51} y={119.9} width={315} height={623} rx={47.1} ry={47.1} fill="#543310" />
